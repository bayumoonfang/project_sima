      ...
      <div class="container-fluid">
        <div class = "div-btn-table" style="margin-bottom: 10px">
             <div class="form-group" style="display: flex">
                <input type="text" class="form-control date_from_asset datepicker" placeholder="Date From">
                <input type="text" class="form-control date_to_asset datepicker2" placeholder="Date To" style="margin-left: 15px">
                <button class="btn btn-primary" style="margin-left: 15px; width: 230px;" onclick="filter_asset()">Filter</button>
            </div>
        </div>
        <br> <br>
...
<script src="{{ asset('js/app_controller/laporan/repasset_controller.js') }}"></script>
