...
<div class="modal fade add-jabatan" id="addUser" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
            ...
            <div class="col">
                <form id = "myForm" name="myForm">
                      ...
                      <div class="form-group">
                        <label for="exampleInputEmail1" class="label-style">Jabatan</label>
                        <input type="text" class="form-control form-style data-jabatan form-checkvalue" name = "data-jabatan" placeholder="Enter Jabatan">
                      </div>
                </form>
            </div>
        </div>
...
<script src="{{ asset('js/app_controller/settings/jabatan_controller.js') }}"></script>
