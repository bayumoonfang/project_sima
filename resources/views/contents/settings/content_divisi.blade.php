...
<div class="modal fade add-divisi" id="addUser" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
            ...
            <div class="col">
                <form id = "myForm" name="myForm">
                      ...
                      <div class="form-group">
                        <label for="exampleInputEmail1" class="label-style">Divisi</label>
                        <input type="text" class="form-control form-style data-divisi form-checkvalue" name = "data-divisi" placeholder="Enter Divisi">
                      </div>
                </form>
            </div>
        </div>
...
<script src="{{ asset('js/app_controller/settings/divisi_controller.js') }}"></script>
