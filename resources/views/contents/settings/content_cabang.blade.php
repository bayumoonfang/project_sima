...
<div class="modal fade add-cabang" id="addUser" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
            ...
            <div class="col">
                <form id = "myForm" name="myForm">
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control form-style data-cabang form-checkvalue" name = "data-cabang" placeholder="Enter Nama Unit">
                      </div>
                        <div class="form-group">
                        <label for="exampleInputEmail1" class="label-style">Alamat</label>
                        <input type="text" class="form-control form-style data-alamat form-checkvalue" name = "data-alamat" placeholder="Enter Alamat Unit">
                      </div>

                        <div class="form-group">
                        <label for="exampleInputEmail1" class="label-style">Phone</label>
                        <input type="number" class="form-control form-style data-phone form-checkvalue" name = "data-phone" placeholder="Enter Phone Unit">
                      </div>
...
<script src="{{ asset('js/app_controller/settings/cabang_controller.js') }}"></script>
