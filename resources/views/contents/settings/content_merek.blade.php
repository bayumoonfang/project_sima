...
<div class="modal fade addMerek" id="addUser" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
            ...
            <div class="col">
                <form id = "myForm" name="myForm">
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control form-style data-merek form-checkvalue" name = "data-merek" placeholder="Enter Merek" list="suggest_merek">
                        <datalist id="suggest_merek">
                            <?php foreach ($data_suggestmerk as $row) { ?>
                                <option value="<?= $row->settm_nama; ?>">
                            <?php } ?>
                        </datalist>
                      </div>

                     <div div class="form-group">
                        <label for="exampleInputEmail1" class="label-style">Tipe</label>
                        <input type="text" class="form-control form-style data-tipe form-checkvalue" name = "data-tipe" placeholder="Enter Tipe">
                      </div>
                </form>
            </div>
        </div>
...
<script src="{{ asset('js/app_controller/settings/merek_controller.js') }}"></script>
