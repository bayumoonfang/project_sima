    ...
    function render_data() {
                    ...
                    columns: [
                        ...
                        { data: 'settd_nama', title: "Divisi", className: "table_link2" },
                    ], lengthMenu: [8],
                    "oLanguage": {
    ...
    function show_addform() {
        $('.add-divisi').modal('show');
        $('.modal-title').text("Add Divisi");
    ...
    $('#myTable').on('click', 'td.table_link2', function(e) {
        ...
        $('.data-id').val(tbl['settd_id']);
        $('.data-divisi').val(tbl['settd_nama']);
    });
