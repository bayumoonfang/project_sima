    ...
    function render_data() {
                    ...
                    columns: [
                        ...
                        { data: 'settm_no', title: "No. Reg", className: "table_link2" },
                        { data: 'settm_nama', title: "Nama" },
                        { data: 'settm_tipe', title: "Tipe"}
                    ], lengthMenu: [8],
                    "oLanguage": {
    ...
    $('#myTable').on('click', 'td.table_link2', function(e) {
        ...
        $('.data-id').val(tbl['settm_no']);
        $('.data-merek').val(tbl['settm_nama']);
        $('.data-tipe').val(tbl['settm_tipe']);
         $('.data-merek').attr('disabled','disabled');
    });
